...
UINT8 current_level_b = 2u; //0 default/wolf, 1 gator, 2 eagle, 3 ibex, 4 bear, 5 walrus
INT8 load_next_gameover = 0;
UINT8 current_level = 2u; // 0u default, 1 sewer, 2 forest, 3 sky, 4 trees, 5 ice cavern, 6 cematery, 7 castle
